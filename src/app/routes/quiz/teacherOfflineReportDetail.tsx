            ...
            try {
                ...
                setQuestions(
                    questionRes.map((q: any) => ({
                        ...
                        totalCorrect: q.totalCorrectAnswers,
                        totalWrong: q.totalWrongAnswers,
                    }))
                );
            } catch (err) {
                console.error(err);
                                    ...
                                    <tbody>
                                        {students.map((s, i) => (
                                            <tr key={i} className="text-center">
                                                ...
                                                <td className="p-3 border ">{s.numberOfCorrectAnswers}</td>
                                                <td className="p-3 border ">{s.numberOfWrongAnswers}</td>
                                                <td className="p-3 border">{s.totalQuestions}</td>
                                                <td className="p-3 border font-semibold">{s.finalScore}</td>
                                                <td className="p-3 border">{s.countAttempts}</td>
                                            </tr>
                                        ))}
                                    </tbody>
                                </table>
